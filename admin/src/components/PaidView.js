...
class Invoice extends Component
{
    ...
    componentWillMount = () =>
    {
        ...
        if (userID !== undefined)
        {
            axios.post('http://localhost:3001/PaidView', 
            {
                codeINV: INVcode
                // codeINV: '00001'
            })
    ...
    render()
    {
        ...
        const invoiceList = this.state.PaidView.map((item, index) =>
        {
                                    ...
                                    <table className="table table-hover">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td>
                                                    <Link to="/Invoice">
                                                        <button className="btn btn-primary"><span className="fa fa-arrow-left">&nbsp;&nbsp;</span>User's Payment</button>    
                                                    </Link>
                                                </td>
                                                <td></td>
                                                <td></td>
